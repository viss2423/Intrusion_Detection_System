...
# Function to predict whether packets are benign or malignant
def predict_packets(selected_interface, tshark_path, model, scaler, label_encoder):
    ...
    for packet in capture.sniff_continuously():
        ...
        if len(features) > 0:
            ...
            if feature_vector is not None:
                ...
                if decoded_prediction[0] == "Malignant":
...
if __name__ == "__main__":
    ...
    # Use the predict_packets function to predict in real-time as packets are processed
    predict_packets(selected_interface, tshark_path, model, scaler, label_encoder)
